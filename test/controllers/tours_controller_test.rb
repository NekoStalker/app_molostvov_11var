...
class ToursControllerTest < ActionController::TestCase
  ...
  test "should create tour" do
    assert_difference('Tour.count') do
      post :create, tour: { days: @tour.days, payment: @tour.payment, route_id: @tour.route_id, tdate: @tour.tdate, tdesc: @tour.tdesc }
    end
  ...
  test "should update tour" do
    patch :update, id: @tour, tour: { days: @tour.days, payment: @tour.payment, route_id: @tour.route_id, tdate: @tour.tdate, tdesc: @tour.tdesc }
    assert_redirected_to tour_path(assigns(:tour))
  end
