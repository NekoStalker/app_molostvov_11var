...
class ExcursionsControllerTest < ActionController::TestCase
  ...
  test "should create excursion" do
    assert_difference('Excursion.count') do
      post :create, excursion: { city_id: @excursion.city_id, edesc: @excursion.edesc, ename: @excursion.ename, eprice: @excursion.eprice }
    end
  ...
  test "should update excursion" do
    patch :update, id: @excursion, excursion: { city_id: @excursion.city_id, edesc: @excursion.edesc, ename: @excursion.ename, eprice: @excursion.eprice }
    assert_redirected_to excursion_path(assigns(:excursion))
  end
